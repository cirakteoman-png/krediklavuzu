    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
      <div className="bg-white rounded-xl p-7 shadow-sm border border-gray-100">
        ...
        <div className="space-y-4">
          ...
          <label className="block">
            <span className="text-xs font-semibold text-gray-700 mb-1.5 block">Peşinat</span>
            <div className="relative">
      ...
      <div className="bg-green-50 rounded-xl p-7 border border-green-200">
        ...
        <div className="space-y-3">
          {teklifler.slice(0, 4).map(t => (
            <div key={t.bank_id} className="bg-white rounded-lg p-3.5 flex items-center justify-between border border-gray-200">
              ...
              <div className="text-right">
                <div className="font-bold text-green-700">%{t.aylik_faiz.toFixed(2)}</div>
