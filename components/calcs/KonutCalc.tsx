...
export default function KonutCalc({ teklifler }: { teklifler: Teklif[] }) {
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
      <div className="bg-surface rounded-xl p-7 shadow-sm border border-line">
        ...
        <div className="space-y-4">
          ...
          <label className="block">
            <span className="text-xs font-semibold text-ink mb-1.5 block">Peşinat</span>
            <div className="relative">
          ...
          <label className="block">
            ...
            <select value={vade} onChange={e => setVade(+e.target.value)}
              ...
              <option value={180}>15 Yıl</option>
              <option value={240}>20 Yıl</option>
            </select>
          </label>
          <label className="block">
